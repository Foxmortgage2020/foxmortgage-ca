...
// POST /api/bookkeeping/review-queue/[id]/reject
// Marks a review queue item as rejected (no QBO write should occur)
// Body: { Reviewer_Notes? }
export async function POST(
  ...
  try {
    ...
    console.error('[POST /api/bookkeeping/review-queue/[id]/reject]', err)
