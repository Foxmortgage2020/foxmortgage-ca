...
export default function MortgageAgentClientsPage() {
  const [clients, setClients] = useState<MortgageAgentClient[]>([])
  ...
  const loadClients = useCallback(() => {
    setLoading(true)
    setError('')
    fetch('/api/portal/mortgage-agent/clients')
      .then(r => r.json())
      .then(data => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/portal/mortgage-agent/add-referral"
                ...
                filtered.map((client) => (
                  ...
                  >
                    <td className="px-5 py-3">
                      <Link
                        href={`/portal/mortgage-agent/clients/${client.id}`}
                    ...
                    <td className="px-5 py-3">
                      <Link href={`/portal/mortgage-agent/clients/${client.id}`}>
