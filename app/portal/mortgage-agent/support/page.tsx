...
export default function MortgageAgentSupportPage() {
  return (
    <div className="max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        {CONTACT.bookingUrl ? (
          ...
          <Link
            href="/portal/mortgage-agent/messages"
            className="bg-white border border-gray-100 rounded-xl p-5 flex items-center gap-4 hover:shadow-md transition-shadow group"
          >
            <div className="w-11 h-11 rounded-full bg-lime/15 flex items-center justify-center group-hover:bg-lime/25 transition-colors">
              <Calendar className="w-5 h-5 text-navy" />
      ...
      <div className="bg-navy text-white rounded-xl p-6">
        ...
        <p className="font-body text-sm text-gray-300 leading-relaxed">
          Michael partners with mortgage agents to give clients fast pre-approvals, transparent rate
          shopping, and reliable closings. Use this portal to refer clients and track their
          mortgage progress through every stage.
        </p>
      </div>
    </div>
  )
