...
const WELCOME: Message = {
  from: 'Michael Fox',
  body: 'Hi! Welcome to your Mortgage Agent portal. Feel free to use this space to ask questions or discuss anything not specific to a single client file.',
  date: '',
}

export default function MortgageAgentMessagesPage() {
  ...
  useEffect(() => {
    fetch('/api/portal/mortgage-agent/messages')
      .then(r => r.json())
      .then(data => {
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/portal/mortgage-agent/message', {
        method: 'POST',
