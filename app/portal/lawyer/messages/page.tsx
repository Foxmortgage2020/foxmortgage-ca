...
const WELCOME: Message = {
  from: 'Michael Fox',
  body: 'Hi! Welcome to the Fox Mortgage Lawyer Portal. Feel free to use this space to ask questions or discuss anything not specific to a single client file.',
  date: '',
}
...
export default function LawyerMessagesPage() {
  ...
  useEffect(() => {
    fetch('/api/portal/lawyer/messages')
      .then(r => r.json())
      .then(data => {
