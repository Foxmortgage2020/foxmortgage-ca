...
const WELCOME: Message = {
  from: 'Michael Fox',
  body: 'Hi! Welcome to the Fox Mortgage Realtor Portal. Feel free to use this space to ask questions or discuss anything not specific to a single client file.',
  date: '',
}
...
export default function RealtorMessagesPage() {
  ...
  useEffect(() => {
    fetch('/api/portal/realtor/messages')
      .then(r => r.json())
      .then(data => {
