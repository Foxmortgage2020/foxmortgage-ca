...
const BACKLOG: { title: string; note: string }[] = [
  { title: 'Command Centre Phase B: page interiors', note: 'The 2026-07-14 shell redesign (Phase A) shipped the grouped sidebar, the Desk strip, decision badges, and the lime-as-decisions rule. Phase B brings each page interior onto the component standards, one surface per brief, starting with the highest-traffic decision surfaces: Approvals, Renewals, Opportunities. A persisted backfill-scan result would also light the Desk strip\u2019s manual-match fragment.' },
