...
const BACKLOG: { title: string; note: string }[] = [
  { title: 'Command Centre Phase B: page interiors (B1 shipped 2026-07-16)', note: 'The 2026-07-14 shell redesign (Phase A) shipped the grouped sidebar, the Desk strip, decision badges, and the lime-as-decisions rule. B1 (the lifecycle spine, 2026-07-16) shipped ONE canonical lifecycle definition (config/lifecycle.ts): the board groups its seven columns under Intake / Underwriting / Fulfilment / Complete & paid, the Home pipeline table groups by the same phases, and every deal room carries a journey stepper with the BRX deck steps per deal shape \u2014 live, by-hand, and coming capabilities each marked honestly. Next: B2 (the deal room laid out phase-aware) and B3 (agent mode). The 72-file visual debt inventory in docs/lifecycle-b1-2026-07-16.md feeds them. A persisted backfill-scan result would also light the Desk strip\u2019s manual-match fragment.' },
