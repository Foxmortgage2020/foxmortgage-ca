        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl font-body text-sm text-navy placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-lime/50 focus:border-lime transition-colors bg-gray-50 hover:border-gray-300"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/portal/sign-in" className="text-xs text-lime font-body font-medium hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl font-body text-sm text-navy placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-lime/50 focus:border-lime transition-colors bg-gray-50 hover:border-gray-300"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full bg-lime text-navy py-3.5 rounded-xl font-heading font-bold text-sm tracking-wide hover:bg-lime/90 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center">
            <p className="text-gray-400 text-xs font-body">
              🔒 Secure access. Authorized partners and investors only.
            </p>
