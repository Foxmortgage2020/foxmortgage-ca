...
> Inserted 2026-07-28 by the documentation split. The two blocks that follow were moved verbatim out of `CLAUDE.md`, unchanged, and all of that history predates the booking session two entry at the foot of this file.
